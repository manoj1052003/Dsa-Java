...
<body>
    ...
    <div class="reset-container">
        ...
        <form action="resetPasswordServlet" method="post">
            ...
            <button type="button" class="btn btn-secondary btn-custom mt-2" onclick="window.location.href='Dashboard.jsp'" >Back</button>
        </form>
    </div>

    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.1/dist/js/bootstrap.bundle.min.js"></script>
<!-- WRITE EVERYTHING IN IF CONDITION  AND IN ELSE PRINT SESSION EXPIRED  -->
</body>
</html>
